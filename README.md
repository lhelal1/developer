...
<li>I'm not a front end developer, but I designed the [entropywith.me](https://entropywith.me) in <code>Figma</code> and deployed using the <code>Node.js</code> framework
